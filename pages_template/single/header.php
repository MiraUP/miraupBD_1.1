  ...
  <div class="row post-data">
    ...
    <div class="col-lg-auto col-sm-12 d-flex align-items-center justify-content-md-end actions">
      <div class="btn-group" role="group">
        ...
        ?>" class="btn btn-primary" target="_blank" title="Download" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip">
          <i class="icon icon-download"></i>
        </a>

        <button type="button" class="btn btn-secondary button-heart favorite-post" id="favorite-post-<?php the_ID(); ?>" title="Favoritar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip">
        ...
        ?>
          <button type="button" class="btn btn-success" data-bs-custom-class="custom-tooltip" data-bs-toggle="offcanvas" data-bs-target="#offcanvasComments" aria-controls="offcanvasComments" title="Comentários">
